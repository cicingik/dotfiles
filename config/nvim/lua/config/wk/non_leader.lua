return {
  ...
  j = { ":HopWord<CR>", "Go to any word in the current buffer" },
  ps = { ":MarkdownPreview<CR>", "Open markdown in web browser" },
  u = {
    name = "UI",
  ...
  p = {
    ...
    v = { "<cmd>VenvSelect<cr>", "Open VenvSelector to pick a venv" },
    c = { "<cmd>VenvSelectCached<cr>",
      "Retrieve the venv from a cache (the one previously used for the same project directory)" },
  },
  ['\\'] = {
    name = "+Terminal",
